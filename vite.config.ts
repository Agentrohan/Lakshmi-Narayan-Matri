...
import apiRoutes from "vite-plugin-api-routes";import { mediaAssetsPlugin } from "./export-plugins/media-assets-plugin.ts";
...
export default defineConfig(({ mode }) => ({
  ...
  optimizeDeps: {
    include: ["react", "react-dom", "react-router"], exclude: ["drizzle-orm", "mysql2"]
  },
