...
export const seoRoutes: SeoRoute[] = [
	{ path: "/",             changefreq: "weekly",  priority: 1.0,  lastmod: "2026-07-30" },
	{ path: "/about",        changefreq: "monthly", priority: 0.8,  lastmod: "2026-07-30" },
	{ path: "/how-it-works", changefreq: "monthly", priority: 0.8,  lastmod: "2026-07-30" },
	{ path: "/contact",      changefreq: "monthly", priority: 0.7,  lastmod: "2026-07-30" },
	{ path: "/register",     changefreq: "monthly", priority: 0.9,  lastmod: "2026-07-30" },
];
