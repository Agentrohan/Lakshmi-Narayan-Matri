...
// <api-imports>
import admin_diagnostics_get from "./api/admin/diagnostics/GET";
import admin_payment_screenshot_get from "./api/admin/payment-screenshot/GET";
import backup_export_get from "./api/backup/export/GET";
import backup_import_post from "./api/backup/import/POST";
...
import profiles_id_patch_8 from "./api/profiles/[id]/PATCH";
...
// <api-registrations>
app.get("/api/admin/diagnostics", admin_diagnostics_get);
app.get("/api/admin/payment-screenshot/:id", admin_payment_screenshot_get);
app.get("/api/backup/export", backup_export_get);
app.post("/api/backup/import", backup_import_post);
...
app.patch("/api/profiles/:id", profiles_id_patch_8);
